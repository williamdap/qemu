...
/*
 * "Anacapa BMC Storage Module" FRU data.
 * board.mfg="Quanta" board.pname="Anacapa BMC Storage Module" matches the
 * entity-manager probe in bmc_storage_module.json, which creates the
 * BMC_Storage_Module chassis entry consumed by bmcweb/Redfish.
 *
 *    {
